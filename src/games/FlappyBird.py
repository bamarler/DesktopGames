...
from src.constants.FlappyBirdConstants import *
...
class FlappyBird():
    def __init__(self):
        ...
        self.gameMenu = GameMenu(self.screen, FLAPPYBIRD_TEXT)
        self.highScore = load_high_score(FLAPPYBIRD)
        self.score = 0
        self.gameEnd = True
        self.pause = False
    ...
    def onTick(self):
        ...
        if (self.highScore < self.score):
            save_high_score(FLAPPYBIRD, self.highScore)
