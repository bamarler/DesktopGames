...
from src.constants.TicTacToeConstants import *
...
class TicTacToe():
    def __init__(self):
        ...
        self.gameMenu = GameMenu(self.screen, TICTACTOE_TEXT)
        self.highScore = load_high_score(TICTACTOE)
        self.score = 0
        self.gameEnd = True
        self.pause = False
    ...
    def onTick(self):
        ...
        if (self.highScore < self.score):
            save_high_score(TICTACTOE, self.highScore)
